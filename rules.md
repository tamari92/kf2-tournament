...
Retries may **only** be used in the situations outlined above and if the current stage of the tournament permits it. It is considered bad sportsmanship to purposely throw the game in order to earn a retry. Tournament Staff reserve the right to enact disciplinary measures if it is determined this is being abused.
