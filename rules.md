![alt_text](https://i.imgur.com/Wkb6dkS.png)
...
### 4.3 - Overflow Pool
Following the conclusion of the **regular registration** period ([4.1](#41---registration)), the **Overflow Pool** shall be formed.

If more players have signed up than there are available Captains, and there are not enough extra players to form a new team, the extra players shall be moved to the Overflow Pool. Players in the pool shall be **grouped by experience** (see [5.22](#522---player-grouping) for more information) and further sorted ascendingly (earliest date first) using the date and time they signed up for the tournament. After regular sign-ups close, **players can continue to sign up for the tournament until the beginning of the first round of the Group Stage** (see [3.1](#31---schedule) for more information). Players who sign up after regular sign-ups close shall be automatically placed into the Overflow Pool in accordance with the aforementioned scheme.

**The ultimate purpose of the Overflow Pool is to function as a buffer of additional participants.** In the event that a team loses players during the competition, the appropriate player group buffer(s) shall be drawn from in order of priority (earliest date first) in order to fill the vacant slot(s) on the team. These players will be contacted by the Tournament Staff and will have **24 hours** to respond before being placed at the back of the queue.
...
#### 6.13.1 - Group Stage
In the **Group Stage**, teams are permitted to make a **single re-attempt** at a match in the event that the squad is wiped out, but only if the wipe occurred before the beginning of **Wave 6.** Retries will not be permitted after this point out of respect for the time of the staff and audience in attendance.
